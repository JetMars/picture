...
/* harmony import */ var _modules_myFilter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/myFilter */ "./src/js/modules/myFilter.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(stateForm);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', stateForm);
  Object(_modules_myFilter__WEBPACK_IMPORTED_MODULE_7__["default"])('.portfolio-wrapper>.all', '.portfolio-menu', '.portfolio-menu>li', '.portfolio-no', 'active');
...
var checkTextInputs = function checkTextInputs(selector) {
  ...
  textInputs.forEach(function (input) {
    ...
    input.addEventListener('input', function (e) {
      ...
      try {
        for (var _iterator = input.value[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var forms = function forms(stateForm) {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_postData__WEBPACK_IMPORTED_MODULE_7__["default"])(api, formData).then(function (res) {
        console.log(res);
...
var modals = function modals() {
  ...
  function showModalBottom() {
    var winScrollTop = Math.floor(window.pageYOffset || document.documentElement.scrollTop);

    if (winScrollTop + document.documentElement.clientHeight >= document.documentElement.offsetHeight && !btnPressed) {
...
var myFilter = function myFilter(contentSelector, menuSelector, triggersSelector, no, active) {
  var contents = document.querySelectorAll(contentSelector);
  var menu = document.querySelector(menuSelector);
  var triggersMenu = document.querySelectorAll(triggersSelector);
  var noContent = document.querySelector(no);

  function clearContent() {
    contents.forEach(function (mark) {
  ...
  menu.addEventListener('click', function (e) {
    ...
    clearContent();
    var filterMarks = Array.from(contents).filter(function (item) {
      return item.classList.contains(type);
    });

    if (filterMarks.length !== 0) {
      filterMarks.forEach(function (item) {
    ...
    if (target && target.tagName == 'LI') {
      triggersMenu.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (myFilter);
...
var puctureSize = function puctureSize(blockSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (puctureSize);
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      function step(time) {
        ...
        console.log(toBlock - progress / speed, widthTop + toBlock);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _services_getResource__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/getResource */ "./src/js/services/getResource.js");
...
var showMoreStyles = function showMoreStyles(trigger, selector) {
...
var sliders = function sliders(sliderSelector, dir, next, prev) {
  var timer = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 4000;
  var slideIndex = 1;
...
/***/ "./src/js/services/getResource.js":
/*!****************************************!*\
  !*** ./src/js/services/getResource.js ***!
  \****************************************/
/*! exports provided: default */
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445 ".concat(url, ", ").concat(res.status));
